package kanika.com.chatoverbluetooth.service;
  ...
  public synchronized int getState(){
    ...
    private class AcceptThread extends Thread{
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                if (secure) {
                    tempSocket = mBluetoothAdapter.listenUsingRfcommWithServiceRecord(NAME_SECURE,
                            UUID_SECURE);
                } else {
                    tempSocket = mBluetoothAdapter.listenUsingInsecureRfcommWithServiceRecord(
